...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"M@sterP0w3r"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"gauge"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"worker"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"Sup3rP0w3r"}
